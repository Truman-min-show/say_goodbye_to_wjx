...
这是一个基于 Python 的问卷星自动填写工具，**核心算法逻辑衍生自 [Zemelee/wjx](https://github.com/Zemelee/wjx)**。在此基础上，本项目进行了全面的工程化重构，并新增了可视化界面（GUI），提供两种使用模式：
...
本项目的后端核心填写逻辑与算法思想主要参考并衍生自以下开源项目：

* **[Zemelee/wjx](https://github.com/Zemelee/wjx)**：感谢原作者提供的核心思路与基础代码。

在此基础上，本项目致力于提升用户体验与工程可用性，主要改进包括：
1.  **GUI 可视化封装**：降低使用门槛，非技术用户也能轻松配置。
2.  **功能扩展**：允许排序题按照自定义的概率排序而非固定的顺序。

如果您喜欢本项目的改进，也请不吝给原作者的项目点个 Star！